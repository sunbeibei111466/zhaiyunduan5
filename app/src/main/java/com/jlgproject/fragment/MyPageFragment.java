...
import com.jlgproject.activity.Recomend_Record_Number;
...
public class MyPageFragment extends BaseFragment implements View.OnClickListener, HttpMessageInfo.IMessage, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View initView(View view) {
        ...
        my_shoucang = (LinearLayout) view.findViewById(R.id.shouchang);//我的收藏
    ...
    public void onClick(View v) {
        if (v == mTv_title_right) {//登录
            ...
            if (UserInfoState.getUserType() == 1) {
                if (User.myUserType(getActivity(), UserInfoState.getHangType())) {
                    ActivityCollector.startA(getActivity(), Recomend_Record_Number.class);
                }
            }
...
//            ToastUtil.showShort(getActivity(), "该功能正在开发中");
            ...
            tellPhone();
        }else if (v==my_shoucang){//我的收藏

        }else if (v==my_class){//我的课程
