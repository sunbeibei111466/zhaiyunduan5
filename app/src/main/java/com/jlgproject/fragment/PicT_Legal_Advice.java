...
public class PicT_Legal_Advice extends BaseFragment implements View.OnClickListener, HttpMessageInfo.IMessage, PullToRefreshBase.OnRefreshListener2 {
    private int pn = 1;
    private int ps = 8;
    ...
    public int getLoadViewId() {
        return R.layout.pic_legal_advice;
    }
    ...
    public void getServiceData(Object o) {
        if (o instanceof Pic_Text_Bean && o != null) {
            ...
            if (pic_text_bean.getState().equals("ok")){
