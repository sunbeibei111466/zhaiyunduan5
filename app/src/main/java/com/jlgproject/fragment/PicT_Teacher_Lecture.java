...
public class PicT_Teacher_Lecture extends BaseFragment implements View.OnClickListener, HttpMessageInfo.IMessage, PullToRefreshBase.OnRefreshListener2 {
    private int pn = 1;
    private int ps = 8;
    //2.是刷新的状态
    ...
    public int getLoadViewId() {
        return R.layout.pic_teahcer_lecture;
    }
