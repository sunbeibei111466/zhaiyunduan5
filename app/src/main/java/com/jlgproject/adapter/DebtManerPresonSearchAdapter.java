...
public class DebtManerPresonSearchAdapter extends BaseAdapter {
    ...
    public DebtManerPresonSearchAdapter(Context context, List<Debt_Preson_Manger.DataBean.ItemsBean> items) {
