...
public class ImageAdapter5 extends BaseAdapter {
    ...
    public ImageAdapter5(Context context, List<com.jlgproject.model.newDebt.SonLevelListBean> xuList) {
        this.xuList = xuList;
...
//        Bitmap bitmap = returnBitMap(xuList.get(post).getList().get(post));
