...
public class Demand_Information_Adapter_New extends BaseAdapter implements HttpMessageInfo.IMessage{

    private Context context ;
    private List<Demand_Informations_New.DataBean.ItemsBean> items;
    private Long id;

    public Demand_Information_Adapter_New(Context context) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            vh= new Demand_Information_Adapter_New.ViewHolder();
