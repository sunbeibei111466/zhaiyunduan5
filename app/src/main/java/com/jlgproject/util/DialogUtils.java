...
public class DialogUtils {
	 ...
	 *  4.对话框show()出来
	 */
    public final static void showConfirmPay(Context context, boolean canceled, String message,final OnButtonEventListener1 buttonEventListener) {
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        final AlertDialog dialog = builder.create();
        dialog.setCanceledOnTouchOutside(false);
        dialog.setCancelable(canceled);
        dialog.show();
        LinearLayout layout = (LinearLayout) ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.show_confirm_pay, null);
        TextView textView= (TextView) layout.findViewById(R.id.tv_content_pay);
        textView.setText(message);
        //  点击现在就去
        Button btCommit = (Button) layout.findViewById(R.id.btnConfirm_pay);
        btCommit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialog.dismiss();
        ...
        Button btCancel = (Button) layout.findViewById(R.id.btnCancel_pay);
        btCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (buttonEventListener != null) {
     ...
     */
    public final static void showDebtDialog(Context context, boolean canceled, final OnButtonEventListener buttonEventListener) {
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        final AlertDialog dialog = builder.create();
        dialog.setCanceledOnTouchOutside(false);
        dialog.setCancelable(canceled);
        dialog.show();
        LinearLayout layout = (LinearLayout) ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.debt_dialog, null);
