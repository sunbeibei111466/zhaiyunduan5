        ...
        switch (v.getId()) {
            ...
            case R.id.ll_ivParent_title://返回
                if (indexPager == 1 || indexPager == 2) {
                    L.e("--onClick----登录页--indexPager------***------"+indexPager);
                    ActivityCollector.startA(this, MainActivity.class, "currMenu",0);
                    L.e("-----currMenu------***"+0);
                } else if(indexPager==5){
                    ActivityCollector.startA(this, H_DebtShoppingMall.class,"shopBack",1);
                } else{
                    L.e("------登录页--indexPager------***------finish---");
                    finish();
                }
                break;
            ...
            if (login != null) {
                ...
                if (login.getState().equals("ok")) {
                    ...
                    if (indexPager == 1) {
                        ...
                        ActivityCollector.startA(this, H_DebtShoppingMall.class);
                    } else {
                        ActivityCollector.startA(this, MainActivity.class, "currMenu", 0);
                    }
