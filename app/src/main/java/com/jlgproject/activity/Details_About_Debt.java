...
import com.jlgproject.adapter.Debt_Assert_Adapter;
import com.jlgproject.adapter.Debt_Demend_Adapter;
...
public class Details_About_Debt extends BaseActivity implements HttpMessageInfo.IMessage ,View.OnClickListener{
    ...
    public void initViews() {
        ...
        payfei.setOnClickListener(this);
        ...
        old_data = (LinearLayout) findViewById(R.id.old_shuju);
        new_data = (LinearLayout) findViewById(R.id.new_data);
        horizontialListView = (HorizontialListView) findViewById(R.id.hori_listview);
        assert_list = (HomeListView) findViewById(R.id.assert_list);
    }
    ...
    private void requestDetail() {
        if (ShowDrawDialog(this)) {
            ...
            HttpMessageInfo<Debts_Maner_Details> info = new HttpMessageInfo<>(BaseUrl.DEBTS_MANGER_DETAIL2, new Debts_Maner_Details());
        ...
        if (o instanceof Debts_Maner_Details) {
            ...
            if (data != null) {
                if (data.getState().equals("ok")) {
                    ...
                    String isnewdata = data.getData().getIsnewdata();//是否是新老数据
                    if (isnewdata.equals("a")){
                        new_data.setVisibility(View.VISIBLE);
                        old_data.setVisibility(View.GONE);

                    }else if (isnewdata.equals("b")){
                        new_data.setVisibility(View.GONE);
                        old_data.setVisibility(View.VISIBLE);}
                    //资产类
                    asset = data.getData().getAsset();
                    demandNewOne = data.getData().getDemandNewOne();//需求类
                     if(demandNewOne.size()==0){
                    ...
                    get_paper.setAdapter(new DebtsDetailsAdpapter(2, this.evidence, this));
                    get_electronic_data.setAdapter(new DebtsDetailsAdpapter(3, electron, this));
                    horizontialListView.setAdapter(new Debt_Demend_Adapter(this,demandNewOne));
                    assert_list.setAdapter(new Debt_Assert_Adapter(this,asset));
...
//                electron":["1","2","3"],"evidence":["2","3","4","9"],"identification":["1","3"]
                    ...
                    gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ImageZoom.show(Details_About_Debt.this, srcList.get(position), srcList);
                        }
                    });
                } else {
