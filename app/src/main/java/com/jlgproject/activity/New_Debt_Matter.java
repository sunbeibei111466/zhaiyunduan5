...
//        ActivityCollector.startA(New_Debt_Matter.this, New_Debt_Matter_Next.class);
        ActivityCollector.startA(New_Debt_Matter.this, NewDebt_Demand.class);
    }
        ...
        if (o instanceof Debt_Query) {
            ...
            if (quryInformation != null) {
                ...
                if (quryInformation.getState().equals("ok")) {
                    ...
                    String str;
                    if(isZhaishiP){
                        str="系统内未找到您输入"+zwr+"的债务人信息";
                    }else{
                        str="系统内未找到您输入"+zqr+"的债务人信息";
                    }
                    DialogUtils.showDialogZsr(this, true,str , new DialogUtils.OnButtonEventListener() {
                        @Override
